...
class CharacterItem extends StatelessWidget {
  const CharacterItem({super.key, required this.item, required this.characterDetail});
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
            Column(
              children: [
                Image.asset('assets/images/background.jpg', height: characterDetail ? 250 : 200 ,width: 180, fit: BoxFit.cover,),
                if (characterDetail)
                Container(
                  width: 180,
            ...
            Image.network(item.image!, height: characterDetail ? 250 : 200, width: 180,),
          ],
        ),
      ),
    );
